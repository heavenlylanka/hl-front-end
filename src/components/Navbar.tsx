...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900 w-full fixed top-0 left-0 z-10">
      <div className="w-full flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <button
            type="button"
            className="flex items-center text-white bg-orange-400 hover:bg-orange-500 focus:ring-4 
           ...
           bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white
            ...
            <li>
              <Link href="/tours" legacyBehavior>
                <a className="block py-2 px-3 md:p-0 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent
